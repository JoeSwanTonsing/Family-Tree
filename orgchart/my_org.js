...
OrgChart.prototype.load = function(t) {
    ...
    if (a.isGroup || o.isGroup || a.isChildOfGroup || o.isChildOfGroup)
        if (a.isGroup || o.isGroup || !a.isChildOfGroup || o.isChildOfGroup)
            if (a.isGroup || o.isGroup || a.isChildOfGroup || !o.isChildOfGroup)
                if (!a.isGroup && !o.isGroup && a.isChildOfGroup && o.isChildOfGroup) a._groupParentNodeId != o._groupParentNodeId && (this._removeGroupIfHasOneNode(a._groupParentNodeId, a.id), this.removeNodeTag(a.id, a._groupParentNodeId, !0), this.addNodeTag(a.id, o._groupParentNodeId, !0), this.link(a.id, o.pid));
    ...
    l.setAttribute("data-field-name", "isAssistant"), l.innerHTML = '<div style="margin-top: 10px;display:inline-block;">Spouse</div><label class="bg-switch"><input val type="checkbox" ' + s + '><span class="bg-slider round"></span></label>', this.wrapperElement.appendChild(e), e.appendChild(r), e.appendChild(n), r.appendChild(a), OrgChart.htmlRipple(r);
    var h = this.fields,
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (a = f[u]).addEventListener("mouseover", function() {
                ...
                if (void 0 === l[r].onClick)
                    ...
                    expandChildren: !1,
                    nodeId: o
                }) : "csv" === r ? s.obj.exportCSV() : "xml" === r ? s.obj.exportXML() : "addInGroup" === r ? s.obj.groupNode(o, n, void 0, !0) : "addAsChild" === r && s.obj.linkNode(o, n);
    ...
    for (c = 0; c < s.length; c++) {
        ...
        if (H) {
            ...
            for (b = 0; b < k.length; b += 3) {
                ...
                (y = r[L.id]) && (o[L.id].state = y.state, o[L.id].state == OrgChart.COLLAPSE && -1 == m.indexOf(L.id) && m.push(L.id)), OrgChart.server._initStates(L, o, t, a, e, m)
            }
        }
    }
    ...
    link: function(t, e, r, i) {
        ...
        for (var l = 0; l < t.children.length; l++) {
            ...
            if ((s.isAssistant || 2 == s.layout) && s.rightNeighbor && "split" == s.rightNeighbor.templateName) switch (r.orientation) {
                ...
                d = d.replaceAll("{xa}", h.xa).replaceAll("{ya}", h.ya).replaceAll("{xb}", h.xb).replaceAll("{yb}", h.yb).replaceAll("{xc}", h.xc).replaceAll("{yc}", h.yc).replaceAll("{xd}", h.xd).replaceAll("{yd}", h.yd), o.push(OrgChart.linkOpenTag.replace("{id}", t.id).replace("{class}", "link " + s.tags.join(" ")).replace("{level}", t.level).replace("{child-id}", s.id)), o.push(d);
            var c = "";
